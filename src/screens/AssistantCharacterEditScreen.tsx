...
import type { AssistantCharacterEditScreenNavigationProp } from "../navigation/types";
...
export function AssistantCharacterEditScreen() {
  const insets = useSafeAreaInsets();
  const navigation =
    useNavigation<AssistantCharacterEditScreenNavigationProp>();
