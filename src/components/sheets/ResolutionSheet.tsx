...
export const ResolutionSheet = memo(function ResolutionSheet({
  onSelect,
  onOpenCustom,
}: {
  onSelect: () => void;
  ...
  const defaultOptions = useMemo<SelectionOption<string>[]>(
    () =>
  ...
  const customOptions = useMemo<SelectionOption<string>[]>(
    () =>
