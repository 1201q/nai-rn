...
export type RendraSelectionOption<T extends string | number> = {
  value: T;
  label: string;
  recommended?: boolean;
};

function RendraSelectionOptionRow<T extends string | number>({
  option,
  selected,
  onSelect,
}: {
  option: RendraSelectionOption<T>;
  selected: boolean;
...
export function RendraSelectionSheet<T extends string | number>({
  options,
  selectedValue,
  onSelect,
}: {
  options: readonly RendraSelectionOption<T>[];
