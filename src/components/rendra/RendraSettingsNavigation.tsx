...
export const RendraSettingsRow = memo(function RendraSettingsRow({
  icon,
  label,
  value,
  onPress,
...
export type RendraSettingsTab = {
  key: string;
  label: string;
  icon: IconName;
};

export const RendraSettingsTabBar = memo(function RendraSettingsTabBar({
  tabs,
  activeKey,
  onChange,
}: {
  tabs: readonly RendraSettingsTab[];
  activeKey: string;
