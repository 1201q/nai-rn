...
import { RendraSegmentedControl, RendraToggle } from "./RendraFormControls";
import type { RegisterRendraSheetDraft } from "./RendraSheetDraft";
...
function ImportOptionRow({
  ...
  return (
    <View style={styles.optionRow}>
      ...
      <RendraToggle value={value} onChange={onChange} label={label} />
    </View>
  );
}

export function RendraMetadataImportSheet({
  parsed,
  registerDraft,
}: {
